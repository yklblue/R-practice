...
samp1 %>%
  summarise(x_bar = mean(area), samp1_med = median(area),
            SD = sd(area), samp1_iqr = IQR(area),
...
```{r sampling-dist}
sample_means50 %>%
  summarise(sample_means50_med = median(x_bar),
            SE = sd(x_bar))
# type your code for the Exercise here, and Run Document
...
```{r price-sampling}
# mean home price of population estimated to be 180878.66
# type your code for this Exercise here, and Run Document
...
# mean of sampling distribution = 180717.35
# type your code for this Exercise here, and Run Document
...
mean_sale_price_estimate <- mean(sample_means15$x_bar)
mean_sale_price_estimate
# type your code for this Exercise here, and Run Document
...
mean_sale_price_estimate <- mean(sample_means150$x_bar)
mean_sale_price_estimate
