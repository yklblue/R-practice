...
<li> The IQRs of the distributions are roughly equal. </li> # answer
</ol>
```{r habit-weight-box}
# type your code for the Question 3 here, and Knit
boxplot(weight ~ habit, data = nc, na.action = NULL)
